...
public interface HekissaListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link HekissaParser#expressao}.
	 * @param ctx the parse tree
	 */
	void enterNExpressao(HekissaParser.NExpressaoContext ctx);
	/**
	 * Exit a parse tree produced by the {@code NExpressao}
	 * labeled alternative in {@link HekissaParser#expressao}.
	 * @param ctx the parse tree
	 */
	void exitNExpressao(HekissaParser.NExpressaoContext ctx);
	/**
